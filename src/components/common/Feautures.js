                ...
                <div className="">
                    <div className="card size shadow-lg">
                        <div className="card-body ">
                            ...
                            <p className="card-text">Rich content covering all aspects, fostering effective and enjoyable learning.</p>
                ...
                <div className="">
                    <div className="card size shadow-lg">
                        <div className="card-body">
                            ...
                            <p className="card-text">Effortless enrollment process for seamless entry into desired courses.</p>
                ...
                <div className="">
                    <div className="card size shadow-lg">
                        <div className="card-body">
                            ...
                            <p className="card-text">Simple sign-up for instant access to diverse educational opportunities.</p>
...
User-friendly tools for instructors to upload and publish courses.</p>
